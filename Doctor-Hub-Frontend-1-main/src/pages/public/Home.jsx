...
const HomePage = () => {
  ...
  // --- Auth State Logic ---
  const homeDoctorsData = DOCTORS.map((doc) => ({
  ...doc,
  profileImage: doc.image,
  fees: doc.fee,
  hospitalName: doc.clinicName,
  tags: doc.symptoms || [],
  conditions: doc.symptoms || [],
  searchKeywords: [
    doc.name,
    doc.specialty,
    doc.city,
  ...
  const filteredDoctors = homeDoctorsData.filter((doc) => {
...
const searchResults = (() => {
    ...
    const doctorResults = homeDoctorsData
      .filter((doc) => {
